...
@Component
public class PersonSecuritySIAMMapperImpl implements PersonSecuritySIAMMapper {

    @Override
    public PersonEntity asPersonEntity(PersonSIAMEntity personSIAMEntity) {
    ...
    @Override
    public List<PersonEntity> asPersonEntities(List<PersonSIAMEntity> personSIAMEntities) {
        if ( personSIAMEntities == null ) {
            return null;
        }

        List<PersonEntity> list = new ArrayList<PersonEntity>( personSIAMEntities.size() );
        for ( PersonSIAMEntity personSIAMEntity : personSIAMEntities ) {
            list.add( asPersonEntity( personSIAMEntity ) );
        }
    ...
    @Override
    public PersonSIAMEntity asPersonSIAMEntity(PersonEntity personEntity) {
