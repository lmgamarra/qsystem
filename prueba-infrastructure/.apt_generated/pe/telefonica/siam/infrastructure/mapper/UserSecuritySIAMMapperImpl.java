...
@Generated(
    ...
    date = "2022-01-19T10:45:53-0500",
    comments = "version: 1.4.1.Final, compiler: Eclipse JDT (IDE) 3.22.0.v20200530-2032, environment: Java 11.0.12 (Eclipse Foundation)"
)
@Component
public class UserSecuritySIAMMapperImpl implements UserSecuritySIAMMapper {

    @Override
    public UserSecurityEntity asUserSecurityEntity(PersonSIAMEntity personSIAMEntity) {
        ...
        userSecurityEntity.setPersona( personSIAMEntityToPersonEntity( personSIAMEntity ) );
        userSecurityEntity.setUsuarioId( personSIAMEntityUsuarioUsuarioId( personSIAMEntity ) );
        userSecurityEntity.setPerfilId( personSIAMEntityUsuarioPerfilPerfilId( personSIAMEntity ) );
        userSecurityEntity.setNombre( personSIAMEntityUsuarioName( personSIAMEntity ) );
        userSecurityEntity.setContrasena( personSIAMEntityUsuarioPassword( personSIAMEntity ) );
        userSecurityEntity.setCreatedAt( personSIAMEntity.getCreatedAt() );
        userSecurityEntity.setDeleteAt( personSIAMEntity.getDeleteAt() );
        userSecurityEntity.setState( personSIAMEntity.isState() );
        userSecurityEntity.setUpdateAt( personSIAMEntity.getUpdateAt() );
        userSecurityEntity.setUserCreate( personSIAMEntity.getUserCreate() );
        userSecurityEntity.setUserDelete( personSIAMEntity.getUserDelete() );
        userSecurityEntity.setUserUpdate( personSIAMEntity.getUserUpdate() );

        return userSecurityEntity;
    }

    @Override
    public List<UserSecurityEntity> asUserSecurityEntitys(List<PersonSIAMEntity> personSIAMEntitys) {
        if ( personSIAMEntitys == null ) {
            return null;
        }

        List<UserSecurityEntity> list = new ArrayList<UserSecurityEntity>( personSIAMEntitys.size() );
        for ( PersonSIAMEntity personSIAMEntity : personSIAMEntitys ) {
            list.add( asUserSecurityEntity( personSIAMEntity ) );
        }
    ...
    @Override
    public PersonSIAMEntity asUserSecuritySIAMEntity(UserSecurityEntity userSecurityEntity) {
        ...
        personSIAMEntity.setUsuario( userSecurityEntityToUserSecuritySIAMEntity( userSecurityEntity ) );
        personSIAMEntity.setUsername( userSecurityEntityPersonaEmail( userSecurityEntity ) );
        personSIAMEntity.setPersonaId( userSecurityEntityPersonaPersonaId( userSecurityEntity ) );
        personSIAMEntity.setPaterno( userSecurityEntityPersonaPaterno( userSecurityEntity ) );
        personSIAMEntity.setMaterno( userSecurityEntityPersonaMaterno( userSecurityEntity ) );
        personSIAMEntity.setCelular( userSecurityEntityPersonaCelular( userSecurityEntity ) );
        personSIAMEntity.setNombres( userSecurityEntityPersonaNombres( userSecurityEntity ) );
        personSIAMEntity.setTelefonoFijo( userSecurityEntityPersonaTelefonoFijo( userSecurityEntity ) );
        personSIAMEntity.setCreatedAt( userSecurityEntity.getCreatedAt() );
        personSIAMEntity.setDeleteAt( userSecurityEntity.getDeleteAt() );
        personSIAMEntity.setState( userSecurityEntity.isState() );
        personSIAMEntity.setUpdateAt( userSecurityEntity.getUpdateAt() );
        personSIAMEntity.setUserCreate( userSecurityEntity.getUserCreate() );
        personSIAMEntity.setUserDelete( userSecurityEntity.getUserDelete() );
        personSIAMEntity.setUserUpdate( userSecurityEntity.getUserUpdate() );

        return personSIAMEntity;
    }

    @Override
    public PersonSIAMEntity asPersonSIAMEntity(UserSecurityEntity userSecurityEntity) {
        if ( userSecurityEntity == null ) {
            return null;
        }
        ...
        personSIAMEntity.setUsuario( userSecurityEntityToUserSecuritySIAMEntity1( userSecurityEntity ) );
        personSIAMEntity.setTipoDocumento( personEntityToDocumentTypeSIAMEntity( userSecurityEntity.getPersona() ) );
        personSIAMEntity.setUsername( userSecurityEntityPersonaEmail( userSecurityEntity ) );
        personSIAMEntity.setPersonaId( userSecurityEntityPersonaPersonaId( userSecurityEntity ) );
        personSIAMEntity.setPaterno( userSecurityEntityPersonaPaterno( userSecurityEntity ) );
        personSIAMEntity.setMaterno( userSecurityEntityPersonaMaterno( userSecurityEntity ) );
        ...
        personSIAMEntity.setTelefonoFijo( userSecurityEntityPersonaTelefonoFijo( userSecurityEntity ) );
        personSIAMEntity.setNombres( userSecurityEntityPersonaNombres( userSecurityEntity ) );
        personSIAMEntity.setNumDocumento( userSecurityEntityPersonaNumDocumento( userSecurityEntity ) );
        personSIAMEntity.setAutenticacionBiometrica( userSecurityEntityPersonaAutenticacionBiometrica( userSecurityEntity ) );
        personSIAMEntity.setEsVendedor( userSecurityEntityPersonaEsVendedor( userSecurityEntity ) );
        personSIAMEntity.setCreatedAt( userSecurityEntity.getCreatedAt() );
        personSIAMEntity.setDeleteAt( userSecurityEntity.getDeleteAt() );
        personSIAMEntity.setState( userSecurityEntity.isState() );
        personSIAMEntity.setUpdateAt( userSecurityEntity.getUpdateAt() );
    ...
    @Override
    public List<UserSecurityEntity> asUserSecurityEntityByUsers(List<UserSecuritySIAMEntity> userSecuritySIAMEntitys) {
        if ( userSecuritySIAMEntitys == null ) {
            return null;
        }

        List<UserSecurityEntity> list = new ArrayList<UserSecurityEntity>( userSecuritySIAMEntitys.size() );
        for ( UserSecuritySIAMEntity userSecuritySIAMEntity : userSecuritySIAMEntitys ) {
            list.add( asUserSecurityEntityByUser( userSecuritySIAMEntity ) );
        }
    ...
    @Override
    public UserSecurityEntity asUserSecurityEntityByUser(UserSecuritySIAMEntity personSIAMEntity) {
        if ( personSIAMEntity == null ) {
            return null;
        }
        ...
        userSecurityEntity.setPersona( personSIAMEntityToPersonEntity1( personSIAMEntity.getPersona() ) );
        userSecurityEntity.setUsuarioId( personSIAMEntity.getUsuarioId() );
        userSecurityEntity.setPerfilId( personSIAMEntityPerfilPerfilId( personSIAMEntity ) );
        userSecurityEntity.setNombre( personSIAMEntity.getName() );
        userSecurityEntity.setContrasena( personSIAMEntity.getPassword() );
        userSecurityEntity.setCanalesComerciales( UserSecuritySIAMMapper.asCommercialChannelEntitiesCustom( personSIAMEntity.getCanalesComerciales() ) );
        userSecurityEntity.setCreatedAt( personSIAMEntity.getCreatedAt() );
        userSecurityEntity.setDeleteAt( personSIAMEntity.getDeleteAt() );
        userSecurityEntity.setState( personSIAMEntity.isState() );
        userSecurityEntity.setUpdateAt( personSIAMEntity.getUpdateAt() );
        ...
        userSecurityEntity.setUserDelete( personSIAMEntity.getUserDelete() );
        userSecurityEntity.setUserUpdate( personSIAMEntity.getUserUpdate() );
        userSecurityEntity.setBloqueado( personSIAMEntity.isBloqueado() );
        userSecurityEntity.setBloqueo( locksSIAMEntityToLocksEntity( personSIAMEntity.getBloqueo() ) );
        userSecurityEntity.setBloqueoAllApp( personSIAMEntity.getBloqueoAllApp() );
        userSecurityEntity.setIpUsuarioActualiza( personSIAMEntity.getIpUsuarioActualiza() );
        userSecurityEntity.setIpUsuarioCreacion( personSIAMEntity.getIpUsuarioCreacion() );
        userSecurityEntity.setIpUsuarioElimina( personSIAMEntity.getIpUsuarioElimina() );
        userSecurityEntity.setPuntoVenta( pointSaleSIAMEntityToPointSaleEntity( personSIAMEntity.getPuntoVenta() ) );

        return userSecurityEntity;
    }

    @Override
    public UserSecuritySIAMEntity asUserSIAMEntity(UserSecurityEntity userSecurityEntity) {
        if ( userSecurityEntity == null ) {
            return null;
        }
        ...
        userSecuritySIAMEntity.setPerfil( userSecurityEntityToProfileSIAMEntity2( userSecurityEntity ) );
        userSecuritySIAMEntity.setUsuarioId( userSecurityEntity.getUsuarioId() );
        userSecuritySIAMEntity.setName( userSecurityEntity.getNombre() );
        userSecuritySIAMEntity.setPassword( userSecurityEntity.getContrasena() );
    ...
    private Integer personSIAMEntityUsuarioUsuarioId(PersonSIAMEntity personSIAMEntity) {
        if ( personSIAMEntity == null ) {
            return null;
        }
        UserSecuritySIAMEntity usuario = personSIAMEntity.getUsuario();
        if ( usuario == null ) {
            return null;
        }
    ...
    private Integer personSIAMEntityUsuarioPerfilPerfilId(PersonSIAMEntity personSIAMEntity) {
        if ( personSIAMEntity == null ) {
            return null;
        }
        UserSecuritySIAMEntity usuario = personSIAMEntity.getUsuario();
        ...
        ProfileSIAMEntity perfil = usuario.getPerfil();
        if ( perfil == null ) {
            return null;
        }
        Integer perfilId = perfil.getPerfilId();
        if ( perfilId == null ) {
            return null;
        }
        return perfilId;
    ...
    private String personSIAMEntityUsuarioName(PersonSIAMEntity personSIAMEntity) {
        if ( personSIAMEntity == null ) {
            return null;
        }
        UserSecuritySIAMEntity usuario = personSIAMEntity.getUsuario();
    ...
    private String personSIAMEntityUsuarioPassword(PersonSIAMEntity personSIAMEntity) {
        if ( personSIAMEntity == null ) {
            return null;
        }
        UserSecuritySIAMEntity usuario = personSIAMEntity.getUsuario();
    ...
    protected ProfileSIAMEntity userSecurityEntityToProfileSIAMEntity(UserSecurityEntity userSecurityEntity) {
        if ( userSecurityEntity == null ) {
            return null;
        }
        ...
        profileSIAMEntity.setPerfilId( userSecurityEntity.getPerfilId() );
    ...
    protected UserSecuritySIAMEntity userSecurityEntityToUserSecuritySIAMEntity(UserSecurityEntity userSecurityEntity) {
        ...
        userSecuritySIAMEntity.setPerfil( userSecurityEntityToProfileSIAMEntity( userSecurityEntity ) );
        userSecuritySIAMEntity.setUsuarioId( userSecurityEntity.getUsuarioId() );
        userSecuritySIAMEntity.setName( userSecurityEntity.getNombre() );
        userSecuritySIAMEntity.setPassword( userSecurityEntity.getContrasena() );
    ...
    private String userSecurityEntityPersonaEmail(UserSecurityEntity userSecurityEntity) {
        if ( userSecurityEntity == null ) {
            return null;
        }
        PersonEntity persona = userSecurityEntity.getPersona();
        if ( persona == null ) {
            return null;
        }
    ...
    private Integer userSecurityEntityPersonaPersonaId(UserSecurityEntity userSecurityEntity) {
        if ( userSecurityEntity == null ) {
            return null;
        }
        PersonEntity persona = userSecurityEntity.getPersona();
    ...
    private String userSecurityEntityPersonaPaterno(UserSecurityEntity userSecurityEntity) {
        if ( userSecurityEntity == null ) {
            return null;
        }
        PersonEntity persona = userSecurityEntity.getPersona();
    ...
    private String userSecurityEntityPersonaMaterno(UserSecurityEntity userSecurityEntity) {
        if ( userSecurityEntity == null ) {
            return null;
        }
        PersonEntity persona = userSecurityEntity.getPersona();
    ...
    private String userSecurityEntityPersonaCelular(UserSecurityEntity userSecurityEntity) {
        if ( userSecurityEntity == null ) {
            return null;
        }
        PersonEntity persona = userSecurityEntity.getPersona();
    ...
    private String userSecurityEntityPersonaNombres(UserSecurityEntity userSecurityEntity) {
        if ( userSecurityEntity == null ) {
            return null;
        }
        PersonEntity persona = userSecurityEntity.getPersona();
    ...
    private String userSecurityEntityPersonaTelefonoFijo(UserSecurityEntity userSecurityEntity) {
        if ( userSecurityEntity == null ) {
            return null;
        }
        PersonEntity persona = userSecurityEntity.getPersona();
        ...
        String telefonoFijo = persona.getTelefonoFijo();
    ...
    protected ProfileSIAMEntity userSecurityEntityToProfileSIAMEntity1(UserSecurityEntity userSecurityEntity) {
        if ( userSecurityEntity == null ) {
            return null;
        }
    ...
    protected UserSecuritySIAMEntity userSecurityEntityToUserSecuritySIAMEntity1(UserSecurityEntity userSecurityEntity) {
        if ( userSecurityEntity == null ) {
            return null;
        }
        ...
        userSecuritySIAMEntity.setPerfil( userSecurityEntityToProfileSIAMEntity1( userSecurityEntity ) );
        userSecuritySIAMEntity.setUsuarioId( userSecurityEntity.getUsuarioId() );
        userSecuritySIAMEntity.setName( userSecurityEntity.getNombre() );
    ...
    private Integer personEntityTipoDocumentoTipoDocumentoId(PersonEntity personEntity) {
        if ( personEntity == null ) {
            return null;
        }
        DocumentTypeEntity tipoDocumento = personEntity.getTipoDocumento();
        if ( tipoDocumento == null ) {
            return null;
        }
        Integer tipoDocumentoId = tipoDocumento.getTipoDocumentoId();
    ...
    protected DocumentTypeSIAMEntity personEntityToDocumentTypeSIAMEntity(PersonEntity personEntity) {
        if ( personEntity == null ) {
            return null;
        }
        ...
        documentTypeSIAMEntity.setTipoDocumentoId( personEntityTipoDocumentoTipoDocumentoId( personEntity ) );
        documentTypeSIAMEntity.setState( personEntity.isState() );

        return documentTypeSIAMEntity;
    }

    private String userSecurityEntityPersonaNumDocumento(UserSecurityEntity userSecurityEntity) {
        if ( userSecurityEntity == null ) {
            return null;
        }
        PersonEntity persona = userSecurityEntity.getPersona();
    ...
    private Boolean userSecurityEntityPersonaAutenticacionBiometrica(UserSecurityEntity userSecurityEntity) {
        if ( userSecurityEntity == null ) {
            return null;
        }
        PersonEntity persona = userSecurityEntity.getPersona();
        ...
        boolean autenticacionBiometrica = persona.isAutenticacionBiometrica();
        return autenticacionBiometrica;
    }

    private Boolean userSecurityEntityPersonaEsVendedor(UserSecurityEntity userSecurityEntity) {
        if ( userSecurityEntity == null ) {
            return null;
        }
        PersonEntity persona = userSecurityEntity.getPersona();
        ...
        boolean esVendedor = persona.isEsVendedor();
        return esVendedor;
    }
    ...
    private Integer personSIAMEntityPerfilPerfilId(UserSecuritySIAMEntity userSecuritySIAMEntity) {
        if ( userSecuritySIAMEntity == null ) {
            return null;
        }
        ProfileSIAMEntity perfil = userSecuritySIAMEntity.getPerfil();
        if ( perfil == null ) {
            return null;
        }
        Integer perfilId = perfil.getPerfilId();
    ...
    protected PersonSIAMEntity personEntityToPersonSIAMEntity(PersonEntity personEntity) {
        ...
        personSIAMEntity.setUsername( personEntity.getEmail() );
    ...
    protected ProfileSIAMEntity userSecurityEntityToProfileSIAMEntity2(UserSecurityEntity userSecurityEntity) {
        if ( userSecurityEntity == null ) {
            return null;
        }
